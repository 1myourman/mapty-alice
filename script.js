...
class Workout {
	date = new Date();
	id = (Date.now() + '').slice(-10); // just for project, in real world we use library ID
	clicks = 0;
...
class App {
	...
	_newWorkout(e) {
		...
		const distance = +inputType.value;
		const duration = inputType.value;
